...
class building {
	...
	void checkPw() {
		...
		if(pw == inputPw) {
			System.out.println("입력하신 비밀번호는 " + inputPw + "입니다.");
			System.out.println("환영합니다, 입주민 여러분");
		} else {
...
public class Ch13 {
	...
	public static void main(String[] args) {
		...
		// 01 클래스 (자료형)
		// 동일한 종류의 객체를 구현하기 위해 객체의 속성/기능을 미리 선언한 자료형, 설계도 혹은 틀임.
...
//		Person a = new Person();
		...
		// 참조변수 (Reference Variable) : 객체를 가리키는 변수를의미
