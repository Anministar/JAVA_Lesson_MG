...
public class Ch05 {
	...
	public static void main(String[] args) {
		...
		// 일단 외워주세요 :)
		// Scanner장치를 생성해 사용할 수 있도록 참조변수 sc 생성 및 연결
//		System.out.println("-------------------------- Scanner 예제 01 ------------------------------");
//		System.out.println("정수를 하나 입력하세요 >>> ");
//		String s = sc.nextLine(); 	// 밑에 실행창의 오른쪽 상단에 젤 왼쪽 보면 빨간불 들어와 있는데 '실행중'이라는 의미
//								// next() : 한문자열(단어), 띄워쓰기 기준으로 한 문자열만 가능
//								// nextLine() : 한 줄
//								// nextInt() : 숫자로 나옴. 대신 변수 앞에 String이 아니라 int로 바꿔줘야함.
...
//		String s2 = sc.next();
//		String s3 = sc.next();
//		System.out.printf("문자열 : %s %s %s", s1, s2, s3);
//		System.out.println();
//		
...
//		System.out.println("--------------- Scanner 문제 02 ---------------");
		...
		//홍길동 님의 나이는 24세이고 주소는 대구광역시 반월당 중구 파출소입니다.
