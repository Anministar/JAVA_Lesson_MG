...
//								// 4byte는 대약 -21억 - 21억까지 저장가능한데 long, int 이기 때문에 4byte안에 100억을 넣을 순없음.
...
//		System.out.println(f);
//		f = (int) 5.5 + (int) 1.5;	// 위에꺼 계산하면 6, 이걸 double f 하면 6.0이 나옴.
//		System.out.println(f);
//		
//		// ==> 실수와의 정수 계산은 항상 실수
//		// 즉, 하나라도 실수가 있다면 계산 결과값가 실수입니다.
//		
//		
//		// 정밀도 확인
...
//											// 문자열 == 문자열 리터럴
//								2			// 문자열 리터럴은 String Pool이라는 영역에 저장
...
//		
//		
//		String s = "this is"; // 문자열을 쓰지 문자'형'을 쓰면 X
...
//		
//		
//		System.out.println(s1);			// 출력이 되는데
////		System.out.println(s2); 		// 오류가 난다.
